...
> 🌐 [English](sso-keycloak.md) · **Deutsch** · [Česky](sso-keycloak.cs.md)
...
bleibt `SAP_AUTH_MODE=basic` (→ [konfiguration.de.md](konfiguration.de.md)) und dieses
...
(die Verbindung bleibt offen). Details: [installation-zentral.de.md](installation-zentral.de.md).
