...
> Anleitungen: [installation-windows.de.md](installation-windows.de.md) /
> [installation-linux.de.md](installation-linux.de.md).
...
- euren **Lizenzschlüssel** (per E-Mail bzw. aus dem
  ...
  Datei `versino.key`; beides funktioniert. Siehe [lizenz.de.md](lizenz.de.md)
...
[installation-windows.de.md](installation-windows.de.md), Abschnitt 3 beschrieben.
...
[erste-schritte.de.md](erste-schritte.de.md).
