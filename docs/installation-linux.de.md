...
> 🌐 [English](installation-linux.md) · **Deutsch** · [Česky](installation-linux.cs.md)

> Für **Windows** gibt es einen **geführten Installer**, der den Großteil der Einrichtung
> automatisiert ([installer.de.md](installer.de.md)). Unter Linux erfolgt die Einrichtung
...
# Anmeldemodus: "basic" oder "bearer" (Browser-SSO über Keycloak)
SAP_AUTH_MODE=basic
...
# Serverstart passen). Im Netzbetrieb die HTTPS-URL (siehe installation-zentral.de.md).
...
siehe [installation-windows.de.md](installation-windows.de.md), Abschnitt 4.
...
- Häufige Fälle (`license.refused`, Verbindungsprobleme) in [troubleshooting.de.md](troubleshooting.de.md).
